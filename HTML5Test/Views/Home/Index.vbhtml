...
<body>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="Virus-tab" data-bs-toggle="tab" data-bs-target="#Virus" type="button" role="tab" aria-controls="Virus" aria-selected="false">Virus</button>
        </li>
        <li class="nav-item" role="presentation">
